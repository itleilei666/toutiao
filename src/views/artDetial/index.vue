  ...
  <div>
    ...
    <van-loading v-if="Object.keys(artObj).length===0" cl type="spinner" size="24px" vertical color="#0094ff">
      文章加载中......
    </van-loading>
    <div v-else>
      <!-- 文章信息区域 -->
      <div class="article-container">
        ...
        <!-- 点赞 -->
        <div class="like-box">
          <van-button @click="loveFn(true)" v-if="artObj.attitude === 1" icon="good-job" type="danger" size="small">已点赞
          </van-button>
