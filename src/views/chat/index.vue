<template>
    <div class="container">
        ...
        <div class="chat-list">
            <div v-for="(obj, index) in list" :key="index">
                ...
                <div class="chat-item left" v-if="obj.name !== 'me'">
                    <van-image fit="cover" round src="https://img2.baidu.com/it/u=746513981,3450604916&fm=253&fmt=auto?w=672&h=433" />
        ...
        <div class="reply-container van-hairline--top">
            <van-field placeholder="说点什么..." v-model="word" @keyup.enter="sendFn">
                <template #button>
